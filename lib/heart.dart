...
/// Compare dynamic iterables with bigEquals
extension HeartIterable on Iterable {
  ...
  bool operator >=(Iterable it) {
    return h.greaterThanIterable(this, it) || h.bigEquals(this, it);
  }
  ...
  /// Returns false if elements cannot be compared.
  bool operator <=(Iterable it) {
    return h.greaterThanIterable(it, this) || h.bigEquals(it, this);
  }
...
extension HeartIterableE<E> on Iterable<E> {
  ...
  ///
  /// [1].group() returns [[1]]
  /// Equivalent to .groupBy((a,b) => bigEquals(a,b)).
  List<List<E>> group() {
  ...
  /// Removes duplicates by using [bigEquals].
  ///
  ...
  /// Removes elements one at a time, using [bigEquals].
  ///
