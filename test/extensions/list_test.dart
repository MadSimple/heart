...
void listTest() {
  test('HeartList', () {
    ...
    expect(isList([l123, l456].zipWith((args) => args[0] + args[1])), true);
    ...
    expect(isList([10, 11, 12].keepIndices(range(0, 2, 2))), true);
    ...
    expect(isList([1].tail!), true);
    expect([1].tail, []);
    expect([1, 2, 3].tail, [2, 3]);
    expect([].tail, null);

    expect(isList([1].tails), true);
    expect([1].tails, [
      [1],
      []
    ]);
    ...
    expect(isList(['one', 'two', 'three'].intersperse(['-'])), true);
    ...
    expect(isList(l4.splitAt(9)), true);
    ...
    expect(isList(l5.groupBy((a, b) => a <= b)), true);
    ...
    expect(isList([10, 11, 12].dropIndices([-100, 0, 0, 0, 2, 100])), true);
    ...
    expect(isList([].nub(elementsToNub: [1, 2])), true);
    ...
    expect(isList(l5.addMissing(l5)), true);
    ...
    expect(isList([1, 1, 2, 2].keep([1, 3, 3, 5])), true);
    ...
    expect(isList([1, 2, 3, 1].subtract([1])), true);
    ...
    expect(isList([1, 2].replace([1], [2])), true);
    ...
    expect(
        isList([1, 2, 3, 4].beforeWhere((e) => e.isEven, reverse: true)), true);
    ...
    expect(isList([1, 2, 3].after([-5])), true);
    ...
    expect(
        isList([1, 2, 3, 4].afterWhere((e) => e.isOdd, reverse: true)), true);
    ...
    expect(isList(intList.ascending), true);
    expect(intList.ascending, [1, 4, 6]);
    expect(isList(intList.descending), true);
    ...
    expect(isList([1, 2, 3].toStrings()), true);
  });
}
...
void listNumTest() {
  test('HeartListNum', () {
    List<num> itn = [1.9, 2.0];
    List<int> l = [1, 2];
    List<num> ln = [1.9, 2.0];
    List<double> ld = [1.9, 2.0];

    expect(isList(itn.toInts()), true);
    expect(itn.toInts(), l);
    ...
    expect(l.toInts(), l);
    expect(isList(l.toDoubles()), true);
    expect(l.toDoubles(), [1.0, 2.0]);
    expect(ld.toInts(), l);
    expect(ld.toDoubles(), [1.9, 2.0]);
    expect(isList(ld.toRounded()), true);
    ...
    expect(isList([0, 5, 6.0].insertInOrder([-1])), true);
...
void listIterableTest() {
  test('HeartListIterable', () {
    expect(
        [
          [],
          [1]
    ...
    expect(isList(l1.intercalate([0, 0])), true);
...
void listStringTest() {
  test('HeartListString', () {
    expect(isList(['abc', '123'].zip()), true);

    expect(isList(<String>['abc', 'axy'].zipWith((args) => args[0] == args[1])),
        true);
  });
}

void listCollectionTest() {
  test('HeartCollectionList', () {
    expect(isList([10, 11, 12].transform((e) => e % 3)), true);
    ...
    expect(isList([10, 11, 12].filter((e) => e.isEven)), true);
    ...
    expect(isList([2, '3', 4].filterType<int>()), true);
    expect([2, '3', 4].filterType<int>(), [2, 4]);

    expect(isList([2, 3, 4].filterNot((e) => e.isEven)), true);
